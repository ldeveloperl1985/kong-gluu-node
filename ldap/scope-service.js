  ...
  _addScope(scopes, this)
    .then(function (scopes) {
      ...
      var attrs = {
        ...
        oxAssociatedClient: that.ldapClient.getDn('ou=clients', 'inum=' + process.env.CLIENT_ID),
    ...
    client.ldapClient.search(scopeDn, '&(objectClass=oxAuthUmaScopeDescription)', [], 'sub', 0,
      function (entries) {
        ...
        scopes.forEach(function (scope) {
          var inum = process.env.LDAP_CLIENT_ID + "!" + getUpperRandom(4) + "." + getUpperRandom(4) + "." + getUpperRandom(4) + "." + getUpperRandom(4);
